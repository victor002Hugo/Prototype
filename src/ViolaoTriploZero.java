public class ViolaoTriploZero extends Prototype {

    private int quantidadeCordas=6;
    private String qualidadeCorda="Aço";
    private double valor=830;


    @Override
    public Prototype clone() {
        System.out.println("Clonou "+ViolaoTriploZero.class);
        ViolaoTriploZero novo = new ViolaoTriploZero();
